...
--
-- Host: 127.0.0.1
-- Generation Time: May 18, 2022 at 02:24 PM
...
(16, 'Sprookjes sprookjes.', 'Efteling', 'Sprookjes park', '2022-05-20', '2022-05-22', 1),
(18, 'Campereeeeeeeeeeen!!!', 'Camping', 'Lekker in de bos camperen', '2022-05-18', '2022-05-25', 100),
(19, 'Oui Oui', 'Parijs', 'We gaan een week naar Parijs met ze alle.', '2022-05-18', '2022-05-25', 60);
...
--
ALTER TABLE `Reis`
  MODIFY `Reis_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT for table `Reis_Inschrijf`
--
ALTER TABLE `Reis_Inschrijf`
  MODIFY `Inschrijf_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
